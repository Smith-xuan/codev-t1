...
async def test_apb_controller_with_delay(dut):
    ...
    for _ in range(num_iterations):
        ...
        select_signals = [
            (dut.select_a_i, dut.addr_a_i.value.integer, dut.data_a_i.value.integer),
            (dut.select_b_i, dut.addr_b_i.value.integer, dut.data_b_i.value.integer),
            (dut.select_c_i, dut.addr_c_i.value.integer, dut.data_c_i.value.integer)
        ]
...
async def test_apb_controller_priority_all_events(dut):
    ...
    await hrs_lb.check_priority(
        ...
        dut.addr_a_i.value.integer,
        dut.data_a_i.value.integer,
    ...
    await hrs_lb.check_priority(
        ...
        dut.addr_b_i.value.integer,
        dut.data_b_i.value.integer,
    ...
    await hrs_lb.check_priority(
        dut,
        [dut.select_c_i],
        dut.addr_c_i.value.integer,
        dut.data_c_i.value.integer,
