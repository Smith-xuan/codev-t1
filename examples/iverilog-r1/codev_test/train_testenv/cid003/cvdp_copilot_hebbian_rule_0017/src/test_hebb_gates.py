...
async def test_hebb_gates(dut):
    ...
    async def apply_stimulus(a, b, gate_select, duration):
        ...
        cocotb.log.info(f"gate_select={gate_select}, a={a}, b={b}, w1={dut.w1.value.to_signed()}, w2={dut.w2.value.to_signed()}, bias={dut.bias.value.to_signed()}, state={bin(dut.present_state.value.integer)}")
