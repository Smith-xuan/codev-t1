...
// Saved at: 2026-01-15T09:38:05.093740
// 
// Metadata:
//   status: success
//   api_status: Success
...
module testbench;
    ...
    initial begin
        ...
        reset = 0;
        // Monitor outputs
        $display("Time\tclk\treset\tcounter\tclk_div2\tclk_div4\tclk_div8");
        $monitor("%0d\t%b\t%b\t%b\t%b\t%b\t%b", $time, clk, reset, dut.counter, clk_div2, clk_div4, clk_div8);
